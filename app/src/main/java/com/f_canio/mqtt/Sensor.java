...
public class Sensor implements Serializable{
    ...
    public Sensor(String idSensor, String nombreSensor, String tipoSensor, String valorSensor, String ubicacionSensor, String fechaRegistro, String observacionSensor) {
