...
public class MainActivity extends AppCompatActivity {
    //en caso de no funcionar con la direccion ip usar este metodoque esta abajo.
    // private static final String serverUri = "tcp://test.mosquitto.org:1883";

    //funciono con la direccion ip
    private static final String serverUri = "tcp://192.168.1.48:1883";
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            mqttAndroidClient.connect(mqttConnectOptions, null, new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    ...
                    try {
                        ...
                        Toast.makeText(MainActivity.this, "Subscrito a Sensores", Toast.LENGTH_SHORT).show();
        ...
        //ver lista de datos firebase.
        sensor_listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(MainActivity.this, listaView.class);
                intent.putExtra("objectodata", sensorList.get(position));
